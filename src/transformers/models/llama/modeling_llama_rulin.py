...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        config._attn_implementation = 'flash_attention_2'  # hack to support FA only
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                layer_outputs = self._gradient_checkpointing_func(
                    ...
                    hidden_states,
                    causal_mask if is_causal else attention_mask,
                    position_ids,
                    past_key_values,
                    output_attentions,
                    use_cache,
                ...
                layer_outputs = decoder_layer(
                    hidden_states,
                    attention_mask=causal_mask if is_causal else attention_mask,
                    position_ids=position_ids,
    ...
    def _update_attention_mask(
        ...
        # TODO: support non-flash attention case
